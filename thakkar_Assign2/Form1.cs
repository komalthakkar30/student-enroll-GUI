...
namespace thakkar_Assign2
{
    public partial class Form1 : Form
    {
            ...
            if (UserInput != -1)
            {
                ...
                else
                {
                    foreach (int rec in obj.CurrentlyEnrolled)
                    {
                        ...
                        OutputMsg += "\n" + String.Format("z{0,-8}  {1,13}, {2,-10} {3,15}", s.ZID, s.LastName, s.FirstName, s.Major);
                    }
                }
        ...
        private void Student_EnrollDrop_Button_Click(object sender, EventArgs e)
        {
            ...
            if (Selected_Student != -1 && Selected_Course != -1)
            {
                ...
                if (ClickedButton.Name == "EnrollStudent_Button")
                {
                    ...
                    else if (newCourse.CreditHours + student.NumOfCreditHoursEnrolled > 18)
                    {
        ...
        private void ApplySearch_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                OutputField_ShowMessage("Nothing was a match for your filtering criteria", 0);
            }
            else
            {
                OutputField_ShowMessage("", null);
            }
